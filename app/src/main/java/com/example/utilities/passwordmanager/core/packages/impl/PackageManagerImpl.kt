package com.example.utilities.passwordmanager.core.packages.impl
...
class PackageManagerImpl(private val context: Context) : PackageManager {
    ...
    override fun getPackages(): Single<List<com.example.utilities.passwordmanager.model.Package>> {
        return Single.fromCallable {
            ...
            .flatMap { list ->
                Observable.fromIterable(list)
                    .map {
                        com.example.utilities.passwordmanager.model.Package(
